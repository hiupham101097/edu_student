import 'package:edu_student/system/base/view/intro/layouts/intro_layout.dart';
...
class IntroView extends StatelessWidget {
  ...
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => IntroView());
  }

  static Page page() => MaterialPage<void>(child: IntroView());
  final viewKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    return const IntroLayout();
  }
}
